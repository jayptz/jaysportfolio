...
const techItems: TechItem[] = [
  // AI & APIs
  { name: 'OpenAI GPT-3.5', icon: SiOpenai, category: 'AI & APIs' },
  { name: 'Google Speech-to-Text', icon: SiGoogle, category: 'AI & APIs' },
  
  // Backend
  { name: 'Python', icon: SiPython, category: 'Backend' },
  { name: 'Flask', icon: SiFlask, category: 'Backend' },
  { name: 'JSON', icon: FaBrain, category: 'Backend' },
...
const techCategories = [
  { name: 'AI & APIs', color: 'bg-green-500', radius: 120, duration: 20 },
  { name: 'Backend', color: 'bg-green-600', radius: 200, duration: 25 },
  { name: 'Frontend', color: 'bg-green-700', radius: 280, duration: 30 }
]
